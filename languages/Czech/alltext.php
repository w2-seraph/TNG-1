...
$text['findplaces'] = "Najít v¹echny osoby s událostmi v tomto místì";

//changed in 13.0.0
$text['problem'] = "V softwaru TNG do¹lo k chybì. Co dìlat:<p>Pokud jste právì nainstalovali upgrade, mo¾ná jste pøeskoèili èást instalaèních pokynù. Vra»te se na stránku readme a znovu si pøeètìte pokyny. Vìnujte zvlá¹tní pozornost kroku týkajícím se struktury databáze.</p><p>Pokud jste nainstalovali TNG poprvé, bude zøejmì nutné vytvoøit databázové tabulky. Vra»te se na stránku readme.html a vyhledejte tento krok.</p><p>Pokud jste vlastníkem webu, mù¾ete kontaktovat podporu TNG pro dal¹í pomoc s tímto problémem. Zkopírujte prosím dotaz ní¾e a vlo¾te jej do své zprávy.</p>";
//added in 13.0.0
