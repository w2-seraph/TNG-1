...
$admtext['mtdna_test'] = "mtDNA (hvatbera)";
...
$text['burialabbr'] = "graf.";  //from descend
$text['marrabbr'] = "G.";
...
//changed in 13.0.0
$text['problem'] = "Villa hefur komið upp í TNG forritinu. Hvað skal gera:<p>Ef þú ert nýbúin(n) að setja inn uppfærslu, þá gæti verið að þú hafir hoppað yfir hlutann með uppsetningarleiðbeiningum. Farðu aftur í readme skýrslu uppfærslunnar og lestu leiðbeiningarnar yfir aftur. Skoðaðu hlutann um uppbyggingu gagnagrunnins sérstaklega vel.</p><p>Ef þú varst að setja TNG upp í fyrsta sinn, gæti verið að þig vanti að búa til töflurnar í gagnagrunninum. Farðu aftur á readme.html síðuna til að finna það skref í leiðbeiningunum.</p><p>Ef þetta er heimasíðan þín, geturðu haft samband við TNG aðstoðina (þar sem þú keyptir forritið). Vinsamlegast afritið fyrirspurnina (query) hér fyrir neðan og settu það inn í tölvupósinn.</p>";
//added in 13.0.0
