...
$text['loginnotsent2'] = "L'adresse de courriel que vous avez fournie ne correspond à aucun compte enregistré. Aucune information n'a été envoyée.";
$text['loginnotsent3'] = "L'adresse de courriel et le pseudonyme que vous avez fournis ne correspondent à aucun compte enregistré. Aucune information n'a été envoyée.";
...
$text['headstones'] = "Pierres tombales";
$text['histories'] = "Histoires";
$text['recordings'] = "Audio";
$text['videos'] = "Video";

//For Google maps use - admin and public pages
$admtext['placelevel'] = "Type de lieu";
$admtext['level1'] = "Rue";
...
//added in 9.0.0
$text['editprofile'] = "Modifier le profil ";
...
$admtext['clearall'] = "Tout désélectionner";
...
$admtext['haplo'] = "Haplogroupe";
$admtext['termsnp'] = "SNP Terminal";
$admtext['signsnp'] = "SNPs importants";
$admtext['atdna_test'] = "ADNat (autosome)";
$admtext['ydna_test'] = "ADN-Y";
$admtext['mtdna_test'] = "ADNmt (mitochondrial)";
...
//changed in 13.0.0
$text['problem'] = "Une erreur est intervenue dans le logiciel TNG. Ce que vous devez faire :<p>Si vous venez d'installer une mise à jour, vous avez peut-être sauté une partie des instructions d'installation. Retournez à la page du Lisez-moi pour relire les instructions. Prêtez une attention particulière à l'étape de la structure de la base de données.</p><p>Si vous venez de faire une première installation de TNG, il est peut-être encore nécessaire de créer les tables de la base de données. Revenez à la page du lisez-moi pour retrouver cette étape.</p><p>Si vous êtes le propriétaire du site, vous pouvez contacter le service assistance de TNG pour obtenir une aide supplémentaire sur ce problème. Merci de copier la requête ci-après et collez-la dans votre message.</p>";
//added in 13.0.0
