 ...
 *
 * Changes 12-29-18 by Steven Davis for TNG timeline 2.3.1
 *
 * Added script files to timeline library to run resources locally
 * 
 * timeline-api.js - Line 70 changed var useLocalResources from false to true
 * Line 270 changed to correct local address: http://127.0.0.1:9999/timeline_2.3.1/ajax/api/simile-ajax-api.js
 * Line 271 changed to correct link for external resources : http://api.simile-widgets.org/ajax/2.2.1/simile-ajax-api.js
 * 
 * simile-ajax-bundle.js - Line 1967 Added path to local file and changed file name from __history__.html to history.html
 * change was necessary because path defaults to the root folder.
 * 
 * history.js - Line 28 changed __history__.html to history.html
 *  
 *================================================== 
 */
...
(function() {
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = useLocalResources ?
            "http://127.0.0.1:9999/timeline_2.3.1/ajax/api/simile-ajax-api.js?bundle=false" :
