...
<p>
<!-- include($mylanguage/spouse_paternal.php) to include the content from you language folder for each language you support on your site. -->   
<br />
...
<p>
Your spouse's maternal Family story goes here.  You can use HTML tags within the body of the story.  You can also use PHP code by inserting the code within a < ? php   ? > section (note that blanks were inserted in between the php starting and ending characters so the php start and end tags would display on the page.
</p>
<h2>Heading 2 tags</h2>
<p>Additional subheadings can be added for content</p>
<h2>Using tables</h2>
