...
$logstring = "<a href=\"/presidents.php\">The Presidents of the United States</a>";
writelog($logstring);
...
<style>
    ...
    <tr>
        ...
        <tr>
         <td>
        	<img src="photos/thumb_jackson-senate.png" border="1" alt="President Andrew Jackson" width="80" height="96" class="smallimg" style="float:left;">
         ...
         <td>
        	<img src="photos/thumb_p16ppuh5opn5g19buifpg6f1i4j0_27605.jpg" border="1" alt="President Martin Van Buren" width="75" height="100" class="smallimg" style="float:left;">
    	...
    	<td>
        	<img src="photos/thumb_William_Henry_Harrison_daguerreotype_edit.jpg" border="1" alt="President William Henry Harrison" width="80" height="95" class="smallimg" style="float:left;">
