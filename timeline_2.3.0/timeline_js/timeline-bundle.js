...
//changed to .toDateString
Timeline.GregorianDateLabeller.prototype.labelPrecise=function(A){return SimileAjax.DateTime.removeTimeZoneOffset(A,this._timeZone).toDateString();
};
...
D.appendChild(A);
D.appendChild(document.createTextNode("]"));
},fillTime:function(A,B){if(this._instant){if(this.isImprecise()){
//suppressing date info in bubbles
//A.appendChild(A.ownerDocument.createTextNode(B.labelPrecise(this._start)));
//A.appendChild(A.ownerDocument.createElement("br"));
//added this line
//if(this._end.toString() != this._start.toString()) {A.appendChild(A.ownerDocument.createTextNode(B.labelPrecise(this._end)));}
